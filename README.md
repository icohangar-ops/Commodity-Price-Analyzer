...
OpCo runs complex payables and offtake structures across Nickel (Ni), Cobalt (Co), Lithium (Li), and Mixed Hydroxide Precipitate (MHP). **Commodity Price Analyzer** turns term sheets into a living model that continuously re-prices OpCo's contracts off real-time commodity curves, powered by **Azure AI Foundry** (Kimi K2.6) for intelligent analysis and **Microsoft Fabric** for enterprise data storage and analytics.
...
|---|---|---|
| **Black Mass Payables** | LME 3-month Ni/Co | 80% grade multiplier; counterparties: Counterparty A, Counterparty B, Counterparty C |
| **Primary Offtaker MHP Offtake** | Fastmarkets MB CO-0005 monthly | 5% floor discount; 10% profit share above $18,000/mt Ni |
| **Lithium Carbonate GTC** | Fastmarkets Li2CO3 99.5% CIF | Floor $18,000/mt, Ceiling $25,000/mt |
| **Counterparty B Feedstock** | Mixed Fastmarkets/LME composite | 90% Li @ 70% payable, 3% Ni @ 90%, 2% Co @ 90% |
...
│   └── test_business_rules.py    # Python unit tests for OpCo business rules
...
5. Run all cells to create the Delta tables:
   ...
   - `ContractCalculations` — OpCo calculation results
