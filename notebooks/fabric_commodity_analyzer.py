...
It ingests commodity data, runs OpCo business rules, and generates
...
# =============================================================================
# CELL 4: OpCo Business Rules (Contract Calculations)
# =============================================================================

GRADE_MULTIPLIER = 0.80
THRESHOLD_PRICE_PER_MT = 18000
FLOOR_DISCOUNT = 0.05
PROFIT_SHARE = 0.10
...
def calculate_all(ni_price, co_price, li_price):
    ...
    effective_li = max(18000, min(li_price, 25000))
    li_gtc = {
        "spot_price": li_price, "effective_price": effective_li,
        "floor_active": li_price < 18000, "ceiling_active": li_price > 25000,
    }
    li_cycle = {
        "li_payable": round(li_price * 0.90 * 0.70, 2),
        "ni_payable": round(ni_price * 0.03 * 0.90, 2),
        "co_payable": round(co_price * 0.02 * 0.90, 2),
        "total_value": round(li_price * 0.90 * 0.70 + ni_price * 0.03 * 0.90 + co_price * 0.02 * 0.90, 2),
    }
    return {
...
print("OpCo Contract Calculations:")
...
system_prompt = (
    "You are a Financial Analyst for OpCo (Global Lithium Innovations), "
