...
│  User's natural-language question about OpCo payables, margins, sensitivity   │
...
│  1. calculate_black_mass_payables(ni, co, grade_multiplier=0.80)            │
│  2. calculate_primary_offtaker_mhp_offtake(ni, co,                         │
│        floor_discount=0.05, profit_share_threshold=18000)                   │
│  3. calculate_lithium_carbonate_gtc(li,                                     │
│        contract_floor=18000, contract_ceiling=25000)                        │
│  4. calculate_composite_feedstock(li, ni, co, feedstock_grade=0.90)         │
...
│                                                                              │
│  Output: JSON with contract_calculations{}, unit_conversions{},                  │
...
**System Prompt Role:** OpCo Commodity Price Analyzer — expert in battery metals recycling economics. Parses query, selects contracts in scope, fetches prices via MCP tools, normalizes to USD/mt, and outputs structured JSON for the Python node.
...
**System Prompt Role:** Financial Analyst specialized in OpCo contract economics. Synthesizes Python results into executive narrative. Does not perform calculations — cites only figures passed from the Python layer.
...
|---|---|---|---|---|
| OpCo Contract Parameters | `f18b7405-05c6-4efd-bb52-2d9530509fa8` | Load (Step 2) | Shared, persistent | Read |
